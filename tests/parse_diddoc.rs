use did_common::{DidDocument, PublicKey, PublicKeyType, PublicKeyEncoded};
        ...
        Ok(DidDocument::with_pubkeys("did:example:21tDAKCERh95uGgKbJNHYp".to_string(),
            vec![
                PublicKey {
                    ...
                    pub_key: PublicKeyEncoded::Base58("H3C2AVvLMv6gmMNam3uVAjZpfkcJCwDwnZn6z3wXmqPV".to_string())
                }
            ]))
    );
}
